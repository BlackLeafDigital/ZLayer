...
func Test_zlayer_UsersAPIService(t *testing.T) {
	...
	t.Run("Test UsersAPIService SetPassword", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var id string

		httpRes, err := apiClient.UsersAPI.SetPassword(context.Background(), id).Execute()
