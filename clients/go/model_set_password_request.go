...
// SetPasswordRequest Body for `POST /api/v1/users/{id}/password`.
type SetPasswordRequest struct {
	// Required when the caller is setting their own password (non-admin path). Admins changing someone else's password may omit this.
