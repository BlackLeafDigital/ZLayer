...
// UpdateUserRequest Body for `PATCH /api/v1/users/{id}`. All fields are optional so a caller can update a single attribute without touching the others.
...
func (o *UpdateUserRequest) SetRoleNil() {
	o.Role.Set(nil)
}
