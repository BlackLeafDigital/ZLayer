...
func Test_zlayer_NetworksAPIService(t *testing.T) {
	...
	t.Run("Test NetworksAPIService DeleteNetwork", func(t *testing.T) {
		...
		httpRes, err := apiClient.NetworksAPI.DeleteNetwork(context.Background(), name).Execute()
	...
	t.Run("Test NetworksAPIService GetNetwork", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.NetworksAPI.GetNetwork(context.Background(), name).Execute()
	...
	t.Run("Test NetworksAPIService UpdateNetwork", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.NetworksAPI.UpdateNetwork(context.Background(), name).Execute()
